...
const CONFIG: Config = {
	families: {
		...
		brand: {hue: 44, saturation: 72, useSaturationFactor: true},
...
hsl(258, calc(10% * var(--saturation-factor)), 2%) 20%
			...
			{name: '--brand-primary-fill', hue: 45, saturation: 85, lightness: 8},
			...
			{name: '--text-on-brand-primary', hue: 45, saturation: 85, lightness: 8},
			...DARK_CODE_TOKENS,
